...
import br.com.alura.domain.Tipo;
...
private ClientHttpConfiguration client;
    ...
    public void listarPetsDoAbrigo() throws IOException, InterruptedException {
        ...
        for (Pet p : petList) {
            ...
            System.out.println(id + " - " + tipo + " - " + nome + " - " + raca + " - " + idade + " ano(s)" + " - " + peso +" kg");
        }
    }

    public void immportarPetsDoAbrigo() throws IOException, InterruptedException {
        System.out.println("Digite o id ou nome do abrigo:");
        String idOuNome = new Scanner(System.in).nextLine();
        ...
        while ((line = reader.readLine()) != null) {
            ...
            Pet pet = new Pet(Tipo.valueOf(tipo.toUpperCase()),nome, raca, idade, cor, peso);
